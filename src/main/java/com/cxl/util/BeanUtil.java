...
import com.cxl.util.annotations.FieldAlias;
...
/**
 * @program: diancan
 * @Description: Bean操作工具类（拷贝方法时支持添加{@link FieldAlias} 注解）
 * @create: 2019-11-01 20:31
...
public class BeanUtil {
    ...
    public static void copyProperties(Object source, Object target, String... ignoreProperties) throws BeansException {
        ...
        for (PropertyDescriptor targetPd : targetPds) {
            ...
            boolean b = ignoreList == null || !ignoreList.contains(targetPd.getName());
            if (writeMethod != null && b) {
            ...
            if (propertyDescriptors != null && propertyDescriptors.length > 0) {
                for (PropertyDescriptor pd : propertyDescriptors) {
                    ...
                    if (!propertyName.equals(b)) {
                        ...
                        Object propertyValue = readMethod.invoke(obj, objects);
